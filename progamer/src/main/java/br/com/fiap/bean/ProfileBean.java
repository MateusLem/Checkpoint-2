...
public class ProfileBean {
	...
	public void save() {
		if(this.profile.getName() != null) {
			profileDAO.saveProfile(this.profile);
			this.profile = new Profile();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Profile successfully saved!", "INFO"));
		}
